        ...
        return (
            <li key={index} className={s.contactItem}>
                ...
                {el.text === 'Go to github'
                    ? <a className={s.contactText} target='_blank' href='https://github.com/OlegWeremyew'
                         rel="noreferrer">{el.text}</a>
                    : el.text === 'Go to linkedIn'
                        ...
                        : el.text === '+375 29 841 39 53'
                            ? <a className={s.contactText} target='_blank' href="tel:+375173582979"
                                 rel="noreferrer">{el.text}</a>
                            : el.text === 'Go to mail'
                                ? <a className={s.contactText} target='_blank'
